...
var getAllSightings = function getAllSightings() {
  return $.ajax({
...
var createSighting = function createSighting(data) {
  return $.ajax({
    url: config.apiOrigin + '/sightings',
    method: 'POST',
    headers: {
...
var updateSighting = function updateSighting(data) {
  return $.ajax({
...
var deleteSighting = function deleteSighting() {
  return $.ajax({
...
var watchEvents = __webpack_require__(14);
...
var signUpSuccess = function signUpSuccess(data) {
  ...
  $('#lblSignUpMessage').text('User ' + data.user.email + ' successfully created.').css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
...
var signUpFailure = function signUpFailure() {
  clearAuthFields();
  $('#lblSignUpMessage').show();
  $('#lblSignUpMessage').text('Error during sign up').css({ 'color': 'red', 'background-color': 'white', 'opacity': '100' }).show();
};
...
var signInSuccess = function signInSuccess(data) {
  ...
  $('#lblSignInMessage').text('User ' + store.user.email + ' successfully signed in.').css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
...
var signInFailure = function signInFailure() {
  clearAuthFields();
  $('#lblSignOutMessage').text('Error during sign in').css({ 'color': 'red', 'background-color': 'white', 'opacity': '100' }).show();
};

var changePasswordSuccess = function changePasswordSuccess() {
  clearAuthFields();
  $('#lblSignInMessage').text('Successfully changed password').css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' }).show();
  $('#lblSignInMessage').fadeTo(3000, 0);
};

var changePasswordFailure = function changePasswordFailure() {
  clearAuthFields();
  $('#lblSignInMessage').text('Error during change password').css({ 'color': 'red', 'background-color': 'white', 'opacity': '100' }).show();
};
...
var signOutSuccess = function signOutSuccess() {
  ...
  $('.sighting-grid').hide();
  $('.userlogin').show();
  $('#lblSignOutMessage').text('User ' + store.user.email + ' successfully signed out.').css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
...
var signOutFailure = function signOutFailure() {
  clearAuthFields();
  $('#lblSignOutMessage').show();
  $('#lblSignOutMessage').text('Error during sign out').css({ 'color': 'red', 'background-color': 'white', 'opacity': '100' }).show();
};

var clearAuthFields = function clearAuthFields() {
...
var onAdd = function onAdd(event) {
  ...
  if ($('#txtbird').val() === '') {
    ...
    api.createSighting(data).then(ui.createSightingSuccess).catch(ui.createSightingFailure);
  }
};
...
var onUpdate = function onUpdate(event) {
  ...
  if ($('#txtupdateid').val() === '') {
    ...
    api.updateSighting(data).then(ui.updateSightingSuccess).catch(ui.updateSightingFailure);
  }
};
...
var onDelete = function onDelete(event) {
  ...
  if ($('#txtdeleteid').val() === '') {
    ...
    api.deleteSighting().then(ui.deleteSightingSuccess).catch(ui.deleteSightingFailure);
  }
};

var onGridLoad = function onGridLoad(event) {
  api.getAllSightings().then(ui.getAllSightingsSuccess).catch(ui.getAllSightingsFailure);
};

var onClearUpdateDeleteInputs = function onClearUpdateDeleteInputs(event) {
  $('#txtupdateid').val('');
  $('#txtupdatebird').val('');
...
var getAllSightingsSuccess = function getAllSightingsSuccess(data) {
  ...
  if (data.sightings.length === 0) {
    ...
    var latestSighting = new Date(data.sightings[0].created_at);
...
var getAllSightingsFailure = function getAllSightingsFailure() {
  clearFormFields();
  $('#lblgirdmessage').text('Error Getting All Sightings').css({ 'background-color': 'white', 'color': 'red', 'opacity': '100' });
  $('#lblgridmessage').show();
};

var createSightingSuccess = function createSightingSuccess(data) {
  clearFormFields();
  // $('#latestsighting').text(Date(data.sighting.created_at))
  $('#lblgridmessage').text('New sighting has been added. ' + 'Bird: ' + data.sighting.bird + '. Features: ' + data.sighting.characteristics + '. Color: ' + data.sighting.body_color + ' by user ' + store.user.email).css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
  $('#lblgridmessage').show();
  $('#lblgridmessage').fadeTo(5000, 0);
  api.getAllSightings().then(getAllSightingsSuccess).catch(getAllSightingsFailure);
};

var createSightingFailure = function createSightingFailure() {
  clearFormFields();
  $('#lblgirdmessage').text('Error Creating Sighting').css({ 'background-color': 'white', 'color': 'red', 'opacity': '100' });
  $('#lblgridmessage').show();
};

var updateSightingSuccess = function updateSightingSuccess(data) {
  clearFormFields();
  $('#lblgridmessage').text('Sighting with id ' + data.sighting.id + ' has been updated by user ' + store.user.email).css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
  $('#lblgridmessage').show();
  $('#lblgridmessage').fadeTo(5000, 0);
  api.getAllSightings().then(getAllSightingsSuccess).catch(getAllSightingsFailure);
};

var updateSightingFailure = function updateSightingFailure() {
  clearFormFields();
  $('#lblgridmessage').text('Error Updating Sighting').css({ 'background-color': 'white', 'color': 'red', 'opacity': '100' });
  $('#lblgridmessage').show();
};

var deleteSightingSuccess = function deleteSightingSuccess() {
  var id = $('#txtdeleteid').val();
  clearFormFields();
  $('#lblgridmessage').text('Sighting with id ' + id + ' has been deleted by user ' + store.user.email).css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
  $('#lblgridmessage').show();
  $('#lblgridmessage').fadeTo(5000, 0);
  api.getAllSightings().then(getAllSightingsSuccess).catch(getAllSightingsFailure);
};

var deleteSightingFailure = function deleteSightingFailure() {
  clearFormFields();
...
module.exports = {
  getAllSightingsSuccess: getAllSightingsSuccess,
  getAllSightingsFailure: getAllSightingsFailure,
  createSightingSuccess: createSightingSuccess,
  createSightingFailure: createSightingFailure,
  updateSightingSuccess: updateSightingSuccess,
  updateSightingFailure: updateSightingFailure,
  deleteSightingSuccess: deleteSightingSuccess,
  deleteSightingFailure: deleteSightingFailure,
